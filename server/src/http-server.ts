 ...
 */
export function createHttpServer(bridge: ExtensionBridge, version: string = '0.0.0'): { server: http.Server; app: express.Express } {
  const app = express();
  ...
  app.get('/', (_req: Request, res: Response) => {
    res.json({
      ...
      connectedUsers: bridge.getConnectedUserIds(),
    });
  });
